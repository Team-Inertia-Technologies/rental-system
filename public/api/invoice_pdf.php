...
try {
    ...
    <table class="header">
        <tr>
            <td><div style="width:120px;height:60px;background:#eee;text-align:center;line-height:60px;">
            <img src="../uploads/ManMyRent.png" alt="Company Logo" style="max-width:100%;max-height:100%;">
            </div></td>
